...
<div class="row">
    <div class="col-6">
        ...
        <form action="/admin/product/store" method="post" id="product-create" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" rules="required|price" name="product_price" 
                id="product_price" placeholder="Enter a product price">
